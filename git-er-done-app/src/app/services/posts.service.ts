				...
				map((postData) => {
					return postData.posts.map((post) => {
						return {
							...
							contactMainPhoneNumber: post.contactMainPhoneNumber,
							contactStreet: post.contactStreet,
							contactCity: post.contactCity,
							contactState: post.contactState,
							contactZip: post.contactZip,
							employeeFirstName: post.employeeFirstName,
							employeeLastName: post.employeeLastName,
							jobNotes: post.jobNotes,
							employeeID: post.employeeID,
							jobCompleted: post.jobCompleted,
							jobDeleted: post.jobDeleted
						};
					});
				})
			)
